...
export default function Winner({ player1, player2, player3, player4, player5 }) {
    ...
    return (
            <ul className={css.scoreList}>
                <li className={css.player}>Mom: {player1}</li>
                <li className={css.player}>Dad: { player2}</li>
                <li className={css.player}>Brother: { player3}</li>
                <li className={css.player}>Sister: {player4}</li>
                <li className={css.player}>Guest: {player5}</li>
            </ul>
    )
}
